...
mod_Accueil_ui <- function(id) {
  ...
  fluidPage(
    sidebarLayout(
      sidebarPanel(
        tags$br(),
        img(src = "www/shiba_def.png", height = "100%", width = "100%", style = "display: block; margin-left: auto; margin-right: auto;"),
      ...
      mainPanel(
        tags$h2("SHIBA", align = "center", style = "color:#08088A; font-family: Georgia; font-size : 40px;"),
        tags$h2("Un outil combinant R, Shiny et STAN 
pour faciliter la réalisation des analyses statistiques Bayésiennes", align = "center", style = "color:#08088A; font-family: Georgia; font-size : 30px;"),
        tags$br(),
        HTML("SHIBA est une application créée par le Groupe Méthodes en Recherche Clinique (GMRC) des Hôpitaux Universitaires de Strasbourg et les membres de l’équipe IMAGES – RaDoScauba du laboratoire iCUBE (CNRS UMR 7357). Elle est entièrement gratuite, sous licence CC-by-nc 4.0 .</br></br>  
SHIBA est une interface graphique permettant de réaliser des analyses bayésiennes via le logiciel de statistiques R et les packages associés sans avoir à coder les instructions nécessaires pour obtenir ces analyses. 
</br></br>Cet outil est proposé <b>sans aucune garantie de validité sur les résultats.</b>
        ...
        # tags$p(includeHTML("www/bayes_plot.html")),
...
#         tags$ul(
#           tags$li("Vérifiez que votre base est au bon format. Un fichier .CSV ou un fichier .TXT de type séparateur = tabulation.", style = "text-align: justify"),
...
#         tags$br(),
#         tags$p(tags$a(img(src = "www/Miniature.jpeg", height = 94, width = 170),
#           target = "_blank",
#           href = "https://www.youtube.com/watch?v=p1TsN3LeQI4&list=PLRC56KyFX6kk3FJ6FuwvTFRd3ZoNFSLlG"
#         ), align = "center"),
